...
export default function GenBtnSmall({ link, text }) {
  return (
    <button className="bg-[var(--color-primary)] font-header text-white font-semibold px-4 py-3 rounded-lg hover:bg-[var(--color-secondary)] hover:text-[#333333] cursor-pointer text-[12px] md:text-[14px] group">
