...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-black)] flex flex-col items-center w-full py-14 px-10">

      <div id="footer-wrapper" className="md:max-w-[1200px]  text-white w-full flex flex-col items-center gap-8 mt-12">
        <VolunteerWithUsCard />
        <div id="line" className="w-50 md:w-[60%] h-[2px] rounded-2xl bg-white mt-8 md:mt-16 mb-20 md:mb-32"></div>
