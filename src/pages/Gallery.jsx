  ...
  return (
    <div className="flex flex-col items-center mt-4 mb-30 justify-center gap-12 px-8 md:px-12 w-full">
      <div id="header-wrapper" className="flex flex-col items-center md:gap-4 mt-12 md:mt-24 mb-12 md:mb-18">
        ...
        <p className="text-(--color-black)/60 bg-gray-100 px-[24px] py-[4px] tracking-tight rounded-[4px] font-medium text-[16px] md:text-[20px] text-center">Pictorial proof of our mission and dedication to a better society</p>
      </div>
