...
export default function Home() {
  return (
    <div className="flex flex-col items-center min-h-screen w-[90%] py-4 gap-48 md:gap-64 md:max-w-[1200px] text-stone-800">
      {/* hero section */}
      ...
      <div className="flex flex-col items-center gap-8" id="hero-section">
        <div className="flex flex-col gap-6 items-center w-full my-8 md:my-8 lg:my-16">
          <h1 className="font-header text-[48px] tracking-tighter font-medium lg:text-[76px] md:text-[62px] text-center w-full md:w-[90%] leading-12 mb-12 md:leading-16 lg:leading-20">Improving life Today for <span className="text-[var(--color-primary)]"> <br />A better Tomorrow,</span> <br />walk with Us!
          </h1>
          <p className="text-center text-[12px] md:text-[14px] text-[#333333] font-medium max-w-[90%] md:max-w-[80%]">Nigeria faces significant poverty, with estimates showing over half the population struggling, particularly in rural areas (around 75.5%) compared to urban areas (around 41.3%), affecting roughly 139 million people by 2025, with children and uneducated adults being disproportionately impacted, despite recent economic growth figures, highlighting severe inequality and access issues to basic services like water and sanitation. </p>
        </div>
      ...
      <div className="flex flex-col items-center md:items-start gap-4 mb-12" id="about-section">
        <div className="flex flex-col items-center gap-2 md:items-start mb-8 md:mb-12 ">
          <h1 className="font-header text-[48px] md:text-[64px] text-center font-medium leading-tight  tracking-tighter"><span className="text-[var(--color-primary)]">Hearts</span> behind the Heart</h1>
          <p className="text-center md:text-left text-[14px] md:text-[18px] text-stone-500 font-medium w-full mb-8">Here is what you need to know about us</p>
        </div>
        ...
        <div className="about-text items-center md:items-start flex flex-col gap-4 mb-6 md:mb-12">
          ...
          <p className="text-center md:text-left text-[14px] md:text-[16px]">Feed The Heart Foundation is a humanitarian non-governmental organization committed to restoring hope and dignity to vulnerable individuals and communities. We focus on feeding the needy, supporting children’s education, and driving sustainable community development initiatives that empower people to thrive.</p>
        </div>
      ...
      <div id="donate-today" className="flex flex-col items-center gap-4 leading-tight mt-6 mb-24 md:mb-32">
