    ...
    <div className="flex flex-col items-center min-h-screen w-[90%] py-4 gap-48 md:gap-64 md:max-w-[1200px] text-stone-800">
      ...
      <div className="flex flex-col items-center gap-8" id="hero-section">
        <div className="flex flex-col gap-6 items-center w-full my-8 md:my-8 lg:my-16">
          <h1 className="font-header text-[48px] tracking-tighter font-medium lg:text-[76px] md:text-[62px] text-center w-full md:w-[90%] leading-12 mb-12 md:leading-16 lg:leading-20">Improving life now for <span className="text-[var(--color-primary)]"> <br />A better Tomorrow,</span> <br />walk with Us!
          </h1>
